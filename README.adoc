...
This agent is the component in stack which registers itself with Kubernetes as an executor for workloads and then locally runs the assigned tasks - without using containers.
